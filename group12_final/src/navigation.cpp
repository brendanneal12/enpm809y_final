...
//===============================================
void navigation::Navigation::set_initial_pose() {
...
//===============================================
void navigation::Navigation::send_goal() {
...
//===============================================
void navigation::Navigation::goal_response_callback(
...
//===============================================
void navigation::Navigation::feedback_callback(
...
//===============================================
void navigation::Navigation::result_callback(
...
int main(int argc, char** argv) {
  ...
  auto node = std::make_shared<navigation::Navigation>("navigation_demo");
  rclcpp::spin(node);
  rclcpp::shutdown();
}